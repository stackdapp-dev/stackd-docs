...
Stack'd currently supports two premium collateral assets on the **Arbitrum** network.

## 1. Wrapped Bitcoin (WBTC)
**"The Gold Standard of Crypto"**

*   **What is it?** WBTC is an ERC-20 token that is 1:1 backed by real Bitcoin. It allows you to use Bitcoin on the Ethereum and Arbitrum networks.
...
## Why these two?
We only accept **Hard Assets**—assets that are verifiable, scarce, and historically provenance as stores of value. We do not accept volatile "meme coins" or unproven utility tokens as collateral, because they introduce too much risk for you (liquidation risk) and the protocol.
